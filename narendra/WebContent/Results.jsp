...
<h3 style="text-shadow:black; text-align: center; "><b>Results Page</b></h3>
...
<div class="typo">
		<div class="container">
			<div class="grid_3 grid_5 w3ls">
				...
				<%
				list=StudentDao.getAllResultsPages();
				
				for(News news:list)
				{
				%>
				<div class="alert alert-info" role="alert">
					<a href="http://<%= news.getUrl() %>" target="_blank"><strong><%= news.getDescription() %></strong></a>
				</div>
			<%
				}
			%>
