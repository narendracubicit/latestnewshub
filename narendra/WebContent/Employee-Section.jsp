...
<div class="typo">
		<div class="container">
			<div class="grid_3 grid_5 w3ls">
				<h3><b>Employee Section</b></h3>
				<div class="alert alert-info" role="alert">
					<a href="all-application-forms.jsp"><strong>ALL APPLICATION FORMS -</strong> This will give you list of GOs on Leave Rules for Employees.</a>
				</div>
				<div class="alert alert-info" role="alert">
				<a href="gpf-information-forms.jsp"><strong>GPF Information Forms -</strong> This will give you information on CCE.</a>
				</div>
				<div class="alert alert-info" role="alert">
					<a href="zpff-information-forms.jsp"><strong>ZPFF Information Forms -</strong>This will give you Health Cards information.</a>
				</div>
				<div class="alert alert-info" role="alert">
				 <a href="gis-information-forms.jsp"><strong>GIS Information Forms -</strong> This will give you AAS Info.</a>
				</div>
				<div class="alert alert-info" role="alert">
					<a href="IT-information.jsp"><strong>IT Information Forms</strong> This will give you STEP UP Information.</a>
				</div>
				<div class="alert alert-info" role="alert">
					<a href="ltc-forms.jsp"><strong>LTC FORMS</strong> This will give you information on Educational Fee Reimbursement.</a>
				</div>
